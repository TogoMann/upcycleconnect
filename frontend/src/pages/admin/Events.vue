    ...
    <div class="admin-page">
        ...
        <div class="table-wrap" v-if="!adminStore.isLoading">
            <table class="data-table">
                ...
                <tbody>
                    <tr v-for="event in adminStore.events" :key="event.id" class="table-row">
                        <td class="cell-id">{{ event.id }}</td>
                        <td>Utilisateur {{ event.created_by }}</td>
                        <td class="cell-date">
                            <div class="date-wrap">
                                <svg
                                    width="13"
                        ...
                        <td class="cell-price">{{ event.price }} €</td>
                        <td>
                            <span v-if="event.approved" class="badge badge--valide">Validé</span>
