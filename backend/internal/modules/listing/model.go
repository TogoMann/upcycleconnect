...
type ListingHandoffMode string

const (
	HandDelivery ListingHandoffMode = "main_propre"
	Locker       ListingHandoffMode = "casier"
)
...
type Listing struct {
	...
	HandoffMode   ListingHandoffMode `db:"handoff_mode" json:"handoff_mode"`
