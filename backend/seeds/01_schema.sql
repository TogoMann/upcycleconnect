...
ALTER TABLE event ADD COLUMN IF NOT EXISTS max_capacity INTEGER;
ALTER TABLE course ADD COLUMN IF NOT EXISTS status VARCHAR(32) NOT NULL DEFAULT 'pending';
ALTER TABLE course ADD COLUMN IF NOT EXISTS correction_comment TEXT;
ALTER TABLE course ADD COLUMN IF NOT EXISTS categorie VARCHAR(64);
ALTER TABLE course ADD COLUMN IF NOT EXISTS duree VARCHAR(32);
ALTER TABLE news ADD COLUMN IF NOT EXISTS status VARCHAR(20) DEFAULT 'publie';
ALTER TABLE news ADD COLUMN IF NOT EXISTS categorie VARCHAR(64);
